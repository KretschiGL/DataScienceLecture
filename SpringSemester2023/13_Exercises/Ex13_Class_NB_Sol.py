...
data = pd.read_csv("./Ex13_Class_NB_Data.csv", sep=";")
data = data[["text", "tag"]]
display(data.head(5))
...
reviews = ["I really liked this movie. The cast was amazing.", "The worst, never watching a moving from this director again", "Had fun. Was good.", "Way to long. The story could have been told in half of the time."]
